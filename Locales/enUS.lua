...
L["Hide Blizzard's overlay for non-private dispels (prevents overlap with the Dispel Overlay tab)."] = true
...
L["Workaround for a Blizzard bug that spams Lua errors when private aura anchors are active. Turn off if it causes display issues."] = true
...
L["No thanks"] = true
L["Prevent Blizzard Private Aura Crash"] = true
L["Private Aura Dispel Overlay"] = true
L["Private Aura Overlay Setup"] = true
L["Private Auras Only"] = true
L["Skip for now"] = true
